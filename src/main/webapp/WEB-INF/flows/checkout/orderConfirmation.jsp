                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach var="cartItem" items="${order.cart.cartItems}">
                            <tr>
                                ...
                                <td class="col-md-9" style="text-align: center"><em>${cartItem.product.productPrice}</em></td>
                                <td class="col-md-9" style="text-align: center"><em>${cartItem.totalPrice}</em></td>
                            </tr>
                        </c:forEach>
