    ...
    <div class="container-full">
        ...
        <div class="col-md-9 col-sm-9">
            <div class="col-md-12 border-grey">
                <h3 class="text-moredanger">gifts & gift cards</h3>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-moredanger">my gift cards</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-right margin-btm-10">
                            <a href="<spring:url value="/customer/wallet/addcard"/>" class="btn btn-default">GET A NEW GIFT CARD</a>
                        </div>
                    </div>
                    <div class="row creditcard-border">
                        ...
                        <div class="col-md-5">
                            <p class="">Kolys ************2599</p>

                        </div>
                        <div class="col-md-3">
                            <p class="">Remaining Balance: $59.63</p>
                        </div>
